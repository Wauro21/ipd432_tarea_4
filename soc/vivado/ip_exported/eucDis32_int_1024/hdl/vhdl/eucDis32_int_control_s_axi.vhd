...
entity eucDis32_int_control_s_axi is
generic (
...
end entity eucDis32_int_control_s_axi;
...
architecture behave of eucDis32_int_control_s_axi is
    ...
    constant ADDR_A_0_BASE  : INTEGER := 16#0100#;
    constant ADDR_A_0_HIGH  : INTEGER := 16#01ff#;
    constant ADDR_A_1_BASE  : INTEGER := 16#0200#;
    constant ADDR_A_1_HIGH  : INTEGER := 16#02ff#;
    constant ADDR_A_2_BASE  : INTEGER := 16#0300#;
    constant ADDR_A_2_HIGH  : INTEGER := 16#03ff#;
    constant ADDR_A_3_BASE  : INTEGER := 16#0400#;
    constant ADDR_A_3_HIGH  : INTEGER := 16#04ff#;
    constant ADDR_A_4_BASE  : INTEGER := 16#0500#;
    constant ADDR_A_4_HIGH  : INTEGER := 16#05ff#;
    constant ADDR_A_5_BASE  : INTEGER := 16#0600#;
    constant ADDR_A_5_HIGH  : INTEGER := 16#06ff#;
    constant ADDR_A_6_BASE  : INTEGER := 16#0700#;
    constant ADDR_A_6_HIGH  : INTEGER := 16#07ff#;
    constant ADDR_A_7_BASE  : INTEGER := 16#0800#;
    constant ADDR_A_7_HIGH  : INTEGER := 16#08ff#;
    constant ADDR_A_8_BASE  : INTEGER := 16#0900#;
    constant ADDR_A_8_HIGH  : INTEGER := 16#09ff#;
    constant ADDR_A_9_BASE  : INTEGER := 16#0a00#;
    constant ADDR_A_9_HIGH  : INTEGER := 16#0aff#;
    constant ADDR_A_10_BASE : INTEGER := 16#0b00#;
    constant ADDR_A_10_HIGH : INTEGER := 16#0bff#;
    constant ADDR_A_11_BASE : INTEGER := 16#0c00#;
    constant ADDR_A_11_HIGH : INTEGER := 16#0cff#;
    constant ADDR_A_12_BASE : INTEGER := 16#0d00#;
    constant ADDR_A_12_HIGH : INTEGER := 16#0dff#;
    constant ADDR_A_13_BASE : INTEGER := 16#0e00#;
    constant ADDR_A_13_HIGH : INTEGER := 16#0eff#;
    constant ADDR_A_14_BASE : INTEGER := 16#0f00#;
    constant ADDR_A_14_HIGH : INTEGER := 16#0fff#;
    constant ADDR_A_15_BASE : INTEGER := 16#1000#;
    constant ADDR_A_15_HIGH : INTEGER := 16#10ff#;
    constant ADDR_B_0_BASE  : INTEGER := 16#1100#;
    constant ADDR_B_0_HIGH  : INTEGER := 16#11ff#;
    constant ADDR_B_1_BASE  : INTEGER := 16#1200#;
    constant ADDR_B_1_HIGH  : INTEGER := 16#12ff#;
    constant ADDR_B_2_BASE  : INTEGER := 16#1300#;
    constant ADDR_B_2_HIGH  : INTEGER := 16#13ff#;
    constant ADDR_B_3_BASE  : INTEGER := 16#1400#;
    constant ADDR_B_3_HIGH  : INTEGER := 16#14ff#;
    constant ADDR_B_4_BASE  : INTEGER := 16#1500#;
    constant ADDR_B_4_HIGH  : INTEGER := 16#15ff#;
    constant ADDR_B_5_BASE  : INTEGER := 16#1600#;
    constant ADDR_B_5_HIGH  : INTEGER := 16#16ff#;
    constant ADDR_B_6_BASE  : INTEGER := 16#1700#;
    constant ADDR_B_6_HIGH  : INTEGER := 16#17ff#;
    constant ADDR_B_7_BASE  : INTEGER := 16#1800#;
    constant ADDR_B_7_HIGH  : INTEGER := 16#18ff#;
    constant ADDR_B_8_BASE  : INTEGER := 16#1900#;
    constant ADDR_B_8_HIGH  : INTEGER := 16#19ff#;
    constant ADDR_B_9_BASE  : INTEGER := 16#1a00#;
    constant ADDR_B_9_HIGH  : INTEGER := 16#1aff#;
    constant ADDR_B_10_BASE : INTEGER := 16#1b00#;
    constant ADDR_B_10_HIGH : INTEGER := 16#1bff#;
    constant ADDR_B_11_BASE : INTEGER := 16#1c00#;
    constant ADDR_B_11_HIGH : INTEGER := 16#1cff#;
    constant ADDR_B_12_BASE : INTEGER := 16#1d00#;
    constant ADDR_B_12_HIGH : INTEGER := 16#1dff#;
    constant ADDR_B_13_BASE : INTEGER := 16#1e00#;
    constant ADDR_B_13_HIGH : INTEGER := 16#1eff#;
    constant ADDR_B_14_BASE : INTEGER := 16#1f00#;
    constant ADDR_B_14_HIGH : INTEGER := 16#1fff#;
    constant ADDR_B_15_BASE : INTEGER := 16#2000#;
    constant ADDR_B_15_HIGH : INTEGER := 16#20ff#;
    ...
    -- memory signals
    signal int_A_0_address0    : UNSIGNED(5 downto 0);
    signal int_A_0_ce0         : STD_LOGIC;
    signal int_A_0_q0          : UNSIGNED(31 downto 0);
    signal int_A_0_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_A_1_address0    : UNSIGNED(5 downto 0);
    signal int_A_1_ce0         : STD_LOGIC;
    signal int_A_1_q0          : UNSIGNED(31 downto 0);
    signal int_A_1_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_A_2_address0    : UNSIGNED(5 downto 0);
    signal int_A_2_ce0         : STD_LOGIC;
    signal int_A_2_q0          : UNSIGNED(31 downto 0);
    signal int_A_2_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_A_3_address0    : UNSIGNED(5 downto 0);
    signal int_A_3_ce0         : STD_LOGIC;
    signal int_A_3_q0          : UNSIGNED(31 downto 0);
    signal int_A_3_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_A_4_address0    : UNSIGNED(5 downto 0);
    signal int_A_4_ce0         : STD_LOGIC;
    signal int_A_4_q0          : UNSIGNED(31 downto 0);
    signal int_A_4_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_A_5_address0    : UNSIGNED(5 downto 0);
    signal int_A_5_ce0         : STD_LOGIC;
    signal int_A_5_q0          : UNSIGNED(31 downto 0);
    signal int_A_5_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_A_6_address0    : UNSIGNED(5 downto 0);
    signal int_A_6_ce0         : STD_LOGIC;
    signal int_A_6_q0          : UNSIGNED(31 downto 0);
    signal int_A_6_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_A_7_address0    : UNSIGNED(5 downto 0);
    signal int_A_7_ce0         : STD_LOGIC;
    signal int_A_7_q0          : UNSIGNED(31 downto 0);
    signal int_A_7_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_A_8_address0    : UNSIGNED(5 downto 0);
    signal int_A_8_ce0         : STD_LOGIC;
    signal int_A_8_q0          : UNSIGNED(31 downto 0);
    signal int_A_8_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_A_9_address0    : UNSIGNED(5 downto 0);
    signal int_A_9_ce0         : STD_LOGIC;
    signal int_A_9_q0          : UNSIGNED(31 downto 0);
    signal int_A_9_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_A_10_address0   : UNSIGNED(5 downto 0);
    signal int_A_10_ce0        : STD_LOGIC;
    signal int_A_10_q0         : UNSIGNED(31 downto 0);
    signal int_A_10_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_A_11_address0   : UNSIGNED(5 downto 0);
    signal int_A_11_ce0        : STD_LOGIC;
    signal int_A_11_q0         : UNSIGNED(31 downto 0);
    signal int_A_11_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_A_12_address0   : UNSIGNED(5 downto 0);
    signal int_A_12_ce0        : STD_LOGIC;
    signal int_A_12_q0         : UNSIGNED(31 downto 0);
    signal int_A_12_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_A_13_address0   : UNSIGNED(5 downto 0);
    signal int_A_13_ce0        : STD_LOGIC;
    signal int_A_13_q0         : UNSIGNED(31 downto 0);
    signal int_A_13_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_A_14_address0   : UNSIGNED(5 downto 0);
    signal int_A_14_ce0        : STD_LOGIC;
    signal int_A_14_q0         : UNSIGNED(31 downto 0);
    signal int_A_14_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_A_15_address0   : UNSIGNED(5 downto 0);
    signal int_A_15_ce0        : STD_LOGIC;
    signal int_A_15_q0         : UNSIGNED(31 downto 0);
    signal int_A_15_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_B_0_address0    : UNSIGNED(5 downto 0);
    signal int_B_0_ce0         : STD_LOGIC;
    signal int_B_0_q0          : UNSIGNED(31 downto 0);
    signal int_B_0_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_B_1_address0    : UNSIGNED(5 downto 0);
    signal int_B_1_ce0         : STD_LOGIC;
    signal int_B_1_q0          : UNSIGNED(31 downto 0);
    signal int_B_1_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_B_2_address0    : UNSIGNED(5 downto 0);
    signal int_B_2_ce0         : STD_LOGIC;
    signal int_B_2_q0          : UNSIGNED(31 downto 0);
    signal int_B_2_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_B_3_address0    : UNSIGNED(5 downto 0);
    signal int_B_3_ce0         : STD_LOGIC;
    signal int_B_3_q0          : UNSIGNED(31 downto 0);
    signal int_B_3_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_B_4_address0    : UNSIGNED(5 downto 0);
    signal int_B_4_ce0         : STD_LOGIC;
    signal int_B_4_q0          : UNSIGNED(31 downto 0);
    signal int_B_4_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_B_5_address0    : UNSIGNED(5 downto 0);
    signal int_B_5_ce0         : STD_LOGIC;
    signal int_B_5_q0          : UNSIGNED(31 downto 0);
    signal int_B_5_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_B_6_address0    : UNSIGNED(5 downto 0);
    signal int_B_6_ce0         : STD_LOGIC;
    signal int_B_6_q0          : UNSIGNED(31 downto 0);
    signal int_B_6_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_B_7_address0    : UNSIGNED(5 downto 0);
    signal int_B_7_ce0         : STD_LOGIC;
    signal int_B_7_q0          : UNSIGNED(31 downto 0);
    signal int_B_7_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_B_8_address0    : UNSIGNED(5 downto 0);
    signal int_B_8_ce0         : STD_LOGIC;
    signal int_B_8_q0          : UNSIGNED(31 downto 0);
    signal int_B_8_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_B_9_address0    : UNSIGNED(5 downto 0);
    signal int_B_9_ce0         : STD_LOGIC;
    signal int_B_9_q0          : UNSIGNED(31 downto 0);
    signal int_B_9_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_B_10_address0   : UNSIGNED(5 downto 0);
    signal int_B_10_ce0        : STD_LOGIC;
    signal int_B_10_q0         : UNSIGNED(31 downto 0);
    signal int_B_10_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_B_11_address0   : UNSIGNED(5 downto 0);
    signal int_B_11_ce0        : STD_LOGIC;
    signal int_B_11_q0         : UNSIGNED(31 downto 0);
    signal int_B_11_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_B_12_address0   : UNSIGNED(5 downto 0);
    signal int_B_12_ce0        : STD_LOGIC;
    signal int_B_12_q0         : UNSIGNED(31 downto 0);
    signal int_B_12_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_B_13_address0   : UNSIGNED(5 downto 0);
    signal int_B_13_ce0        : STD_LOGIC;
    signal int_B_13_q0         : UNSIGNED(31 downto 0);
    signal int_B_13_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_B_14_address0   : UNSIGNED(5 downto 0);
    signal int_B_14_ce0        : STD_LOGIC;
    signal int_B_14_q0         : UNSIGNED(31 downto 0);
    signal int_B_14_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_B_15_address0   : UNSIGNED(5 downto 0);
    signal int_B_15_ce0        : STD_LOGIC;
    signal int_B_15_q0         : UNSIGNED(31 downto 0);
    signal int_B_15_address1   : UNSIGNED(5 downto 0);
    ...
    component eucDis32_int_control_s_axi_ram is
        generic (
    ...
    end component eucDis32_int_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_A_0
int_A_0 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_0_q1);
-- int_A_1
int_A_1 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_1_q1);
-- int_A_2
int_A_2 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_2_q1);
-- int_A_3
int_A_3 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_3_q1);
-- int_A_4
int_A_4 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_4_q1);
-- int_A_5
int_A_5 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_5_q1);
-- int_A_6
int_A_6 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_6_q1);
-- int_A_7
int_A_7 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_7_q1);
-- int_A_8
int_A_8 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_8_q1);
-- int_A_9
int_A_9 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_9_q1);
-- int_A_10
int_A_10 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_10_q1);
-- int_A_11
int_A_11 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_11_q1);
-- int_A_12
int_A_12 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_12_q1);
-- int_A_13
int_A_13 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_13_q1);
-- int_A_14
int_A_14 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_14_q1);
-- int_A_15
int_A_15 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_15_q1);
-- int_B_0
int_B_0 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_0_q1);
-- int_B_1
int_B_1 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_1_q1);
-- int_B_2
int_B_2 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_2_q1);
-- int_B_3
int_B_3 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_3_q1);
-- int_B_4
int_B_4 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_4_q1);
-- int_B_5
int_B_5 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_5_q1);
-- int_B_6
int_B_6 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_6_q1);
-- int_B_7
int_B_7 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_7_q1);
-- int_B_8
int_B_8 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_8_q1);
-- int_B_9
int_B_9 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_9_q1);
-- int_B_10
int_B_10 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_10_q1);
-- int_B_11
int_B_11 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_11_q1);
-- int_B_12
int_B_12 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_12_q1);
-- int_B_13
int_B_13 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_13_q1);
-- int_B_14
int_B_14 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_14_q1);
-- int_B_15
int_B_15 : eucDis32_int_control_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_A_0_read = '0') and (int_A_1_read = '0') and (int_A_2_read = '0') and (int_A_3_read = '0') and (int_A_4_read = '0') and (int_A_5_read = '0') and (int_A_6_read = '0') and (int_A_7_read = '0') and (int_A_8_read = '0') and (int_A_9_read = '0') and (int_A_10_read = '0') and (int_A_11_read = '0') and (int_A_12_read = '0') and (int_A_13_read = '0') and (int_A_14_read = '0') and (int_A_15_read = '0') and (int_B_0_read = '0') and (int_B_1_read = '0') and (int_B_2_read = '0') and (int_B_3_read = '0') and (int_B_4_read = '0') and (int_B_5_read = '0') and (int_B_6_read = '0') and (int_B_7_read = '0') and (int_B_8_read = '0') and (int_B_9_read = '0') and (int_B_10_read = '0') and (int_B_11_read = '0') and (int_B_12_read = '0') and (int_B_13_read = '0') and (int_B_14_read = '0') and (int_B_15_read = '0') else '0';
    RVALID    <= RVALID_t;
...
-- ----------------------- Memory logic ------------------
    ...
    int_A_0_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_A_1_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_A_2_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_A_3_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_A_4_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_A_5_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_A_6_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_A_7_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- A_8
    int_A_8_address0     <= UNSIGNED(A_8_address0);
    int_A_8_ce0          <= A_8_ce0;
    A_8_q0               <= STD_LOGIC_VECTOR(RESIZE(int_A_8_q0, 32));
    int_A_8_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- A_9
    int_A_9_address0     <= UNSIGNED(A_9_address0);
    int_A_9_ce0          <= A_9_ce0;
    A_9_q0               <= STD_LOGIC_VECTOR(RESIZE(int_A_9_q0, 32));
    int_A_9_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- A_10
    int_A_10_address0    <= UNSIGNED(A_10_address0);
    int_A_10_ce0         <= A_10_ce0;
    A_10_q0              <= STD_LOGIC_VECTOR(RESIZE(int_A_10_q0, 32));
    int_A_10_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- A_11
    int_A_11_address0    <= UNSIGNED(A_11_address0);
    int_A_11_ce0         <= A_11_ce0;
    A_11_q0              <= STD_LOGIC_VECTOR(RESIZE(int_A_11_q0, 32));
    int_A_11_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- A_12
    int_A_12_address0    <= UNSIGNED(A_12_address0);
    int_A_12_ce0         <= A_12_ce0;
    A_12_q0              <= STD_LOGIC_VECTOR(RESIZE(int_A_12_q0, 32));
    int_A_12_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- A_13
    int_A_13_address0    <= UNSIGNED(A_13_address0);
    int_A_13_ce0         <= A_13_ce0;
    A_13_q0              <= STD_LOGIC_VECTOR(RESIZE(int_A_13_q0, 32));
    int_A_13_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- A_14
    int_A_14_address0    <= UNSIGNED(A_14_address0);
    int_A_14_ce0         <= A_14_ce0;
    A_14_q0              <= STD_LOGIC_VECTOR(RESIZE(int_A_14_q0, 32));
    int_A_14_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- A_15
    int_A_15_address0    <= UNSIGNED(A_15_address0);
    int_A_15_ce0         <= A_15_ce0;
    A_15_q0              <= STD_LOGIC_VECTOR(RESIZE(int_A_15_q0, 32));
    int_A_15_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_B_0_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_B_1_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_B_2_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_B_3_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_B_4_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_B_5_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_B_6_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_B_7_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- B_8
    int_B_8_address0     <= UNSIGNED(B_8_address0);
    int_B_8_ce0          <= B_8_ce0;
    B_8_q0               <= STD_LOGIC_VECTOR(RESIZE(int_B_8_q0, 32));
    int_B_8_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- B_9
    int_B_9_address0     <= UNSIGNED(B_9_address0);
    int_B_9_ce0          <= B_9_ce0;
    B_9_q0               <= STD_LOGIC_VECTOR(RESIZE(int_B_9_q0, 32));
    int_B_9_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- B_10
    int_B_10_address0    <= UNSIGNED(B_10_address0);
    int_B_10_ce0         <= B_10_ce0;
    B_10_q0              <= STD_LOGIC_VECTOR(RESIZE(int_B_10_q0, 32));
    int_B_10_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- B_11
    int_B_11_address0    <= UNSIGNED(B_11_address0);
    int_B_11_ce0         <= B_11_ce0;
    B_11_q0              <= STD_LOGIC_VECTOR(RESIZE(int_B_11_q0, 32));
    int_B_11_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- B_12
    int_B_12_address0    <= UNSIGNED(B_12_address0);
    int_B_12_ce0         <= B_12_ce0;
    B_12_q0              <= STD_LOGIC_VECTOR(RESIZE(int_B_12_q0, 32));
    int_B_12_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- B_13
    int_B_13_address0    <= UNSIGNED(B_13_address0);
    int_B_13_ce0         <= B_13_ce0;
    B_13_q0              <= STD_LOGIC_VECTOR(RESIZE(int_B_13_q0, 32));
    int_B_13_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- B_14
    int_B_14_address0    <= UNSIGNED(B_14_address0);
    int_B_14_ce0         <= B_14_ce0;
    B_14_q0              <= STD_LOGIC_VECTOR(RESIZE(int_B_14_q0, 32));
    int_B_14_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    -- B_15
    int_B_15_address0    <= UNSIGNED(B_15_address0);
    int_B_15_ce0         <= B_15_ce0;
    B_15_q0              <= STD_LOGIC_VECTOR(RESIZE(int_B_15_q0, 32));
    int_B_15_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
...
entity eucDis32_int_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity eucDis32_int_control_s_axi_ram;

architecture behave of eucDis32_int_control_s_axi_ram is

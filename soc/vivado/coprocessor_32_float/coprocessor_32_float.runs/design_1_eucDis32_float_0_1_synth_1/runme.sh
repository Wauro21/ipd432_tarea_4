...
HD_PWD='E:/Magisterio/IPD-432/Tarea_4/ipd432_tarea_4/soc/vivado/coprocessor_32_float/coprocessor_32_float.runs/design_1_eucDis32_float_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_eucDis32_float_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_eucDis32_float_0_1.tcl

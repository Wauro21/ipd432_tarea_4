...
HD_PWD='E:/Magisterio/IPD-432/Tarea_4/ipd432_tarea_4/soc/vivado/project_1/project_1.runs/design_1_eucDis32_int_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_eucDis32_int_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_eucDis32_int_0_0.tcl
